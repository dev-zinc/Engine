...
namespace EngineComponentFactory {
    ...
    VkDeviceCreateInfo createDeviceCreateInfo(const std::vector<VkDeviceQueueCreateInfo>& queueCreateInfoList, VkPhysicalDeviceFeatures physicalDeviceFeatures, const std::vector<const char*>& deviceExtensions);
    ...
    // Create Render Pass
    VkRenderPassCreateInfo createRenderPassCreateInfo(VkFormat format, const VkSubpassDescription &subpassDescription);
